...
| 9   | content     | Display exact hours for clicked activity in center           | major  | Exact hours give users precise time values for the selected activity.          | None         |
| 10  | content     | Display percentage for clicked activity in center            | major  | The percentage shows the proportion of time for the selected activity.         | None         |
