...
| 10  | layout      | Position "Other" destination node at bottom right                | minor  | Bottom right positioning for "Other" separates it from primary zones, indicating its special nature.      | C9           |
...
| 12  | content     | Display detail card with source, destination, and flow percentage | major  | The detail card gives users precise information about the specific flow they clicked.                     | C11          |
