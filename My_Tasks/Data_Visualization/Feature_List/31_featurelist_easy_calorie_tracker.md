...
| 5   | state       | Load data with some meals meeting and some exceeding the 600 calorie limit         | major  | Mixed data ensures both blue and red bars are visible for comparison.               | None         |
