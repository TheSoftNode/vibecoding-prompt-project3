...
| 5   | state       | Load data with at least one zone at 50 meters or shallower and at least one above 50 meters | major  | Mixed depths guarantee both color types appear on screen.                           | None         |
| 6   | content     | Display realistic sample depths in meters                                          | major  | Depth numbers give users actual measurement values.                                 | C4           |
