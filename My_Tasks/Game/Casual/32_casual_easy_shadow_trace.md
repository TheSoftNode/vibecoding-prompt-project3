...
Prompt: Hover to draw a fading trail. Click target dots to remove them and increase hit count at top. Trail disappears after time.
...
| 3   | state       | Make trail disappear after time                  | major  | Fading creates the time pressure mechanic.                                 | C2           |
