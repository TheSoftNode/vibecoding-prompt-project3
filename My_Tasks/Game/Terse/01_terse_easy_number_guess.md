...
| 4   | content     | Display "Correct!" or "Wrong! It was [color]" message when player clicks a colored box             | major  | The specific message text tells the player the result and what the correct answer was.                                                                            | C3           |
...
| 8   | content     | Label the Reset button with the text "Reset"                                                       | major  | The exact label identifies the button's purpose clearly.                                                                                                          | C7           |
