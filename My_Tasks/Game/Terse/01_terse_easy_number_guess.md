...
| 12  | state       | Reset guess count to zero and maintain it at zero when a new game begins | major  | Automatically resetting and maintaining the counter at zero when a new game is detected ensures clean state and accurate attempt tracking without direct user interaction with the counter. | C11           |
