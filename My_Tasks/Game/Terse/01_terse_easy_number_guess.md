...
| 12  | state       | Reset guess count to zero when a new game begins                         | major  | Automatically resetting the counter to zero when a new game is detected ensures clean state and accurate attempt tracking without direct user interaction with the counter. | C11           |
