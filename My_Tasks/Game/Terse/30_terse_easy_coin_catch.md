...
Prompt: Meteors fall from top. Move shield left/right with arrow keys to catch meteors. Show score at top.
...
| --- | ----------- | -------------------------------------------- | ------ | -------------------------------------------------------------------------- | ------------ |
| 1   | visual      | Display falling meteor objects               | major  | Showing meteors gives players the targets they need to catch.              | None         |
