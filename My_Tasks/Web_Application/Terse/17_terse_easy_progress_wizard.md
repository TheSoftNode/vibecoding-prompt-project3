...
| 5   | visual      | Highlight current step blue, completed green, future gray | major | Color-coded highlighting shows which steps are done, current, and upcoming.                                      | None         |
| 6   | visual      | Display "Next" button                                 | major  | The button lets users move forward through the wizard.                                                           | None         |
| 7   | state       | Start wizard on step 1 (Personal Info)                | minor  | Starting at step 1 puts users at the beginning of the workflow.                                                  | None         |
| 8   | interaction | Advance to next step when "Next" button is clicked    | major  | Clicking Next moves users forward through the step sequence.                                                     | C6           |
